...
var stui = {
	...
	mobile: {
		...
		slide: function() {
			$.getScript(maccms.path+"/template/dgyfshfjg/js/flickity.pkgd.min.js", function() {
	...
	images: {
		lazyload: function() {
			$.getScript(maccms.path+"/template/dgyfshfjg/js/jquery.lazyload.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 15,
	...
	common: {
		bootstrap: function() {
			$.getScript(maccms.path+"/template/dgyfshfjg/js/bootstrap.min.js", function() {
		...
		headroom: function() {
			$.getScript(maccms.path+"/template/dgyfshfjg/js/headroom.min.js", function() {
				$("#header-top", function() {
