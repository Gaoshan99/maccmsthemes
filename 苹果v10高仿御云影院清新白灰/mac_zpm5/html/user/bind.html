			...
			<div id="listCon">
				...
				<div class="cur">
					<form id="fm" name="fm" method="post" action="" >
						...
						<p><span class="xiang">{if condition="$ac eq 'phone'"}手机{else/}邮箱{/if}：</span><input type="text" name="to" class="member-input" value=""><input type="button" id="btn_bind_email" value="获取验证码"/></p>
