...
<div class="layout clearfix">
	<div class="reg-w">
		<form method="post" id="fm" action="">
			...
			<h4>邮箱找回密码</h4>
			<div class="reg-group">
				<label class="bd-r" style="letter-spacing: normal;">邮箱</label>
				<input type="text" id="user_email" name="user_email" class="reg-control" placeholder="请输入您绑定的邮箱">
			</div>
			<div class="reg-group">
				<label>验证码</label>
			...
			<input type="button" id="btn_send" class="btn-brand btn-sub" style="margin-top:5px;" value="发送邮件">
		</form>
		...
		<form method="post" id="fm2" action="">
			...
			<div class="reg-group">
				...
				<input type="text" id="code" name="code" class="reg-control" placeholder="请输入邮件验证码">
			</div>
			<div class="reg-group">
				<label>新密码</label>
