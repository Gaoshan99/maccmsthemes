...
var MAC={
    ...
    'History': {
        ...
        'Init':function(){
            ...
            html = '<div class="mac_drop_box mac_history_box" style="display:none;">';
			html += '<div class="watch-list-inner"></div><i class="watch-list-triangle"></i>';
            html +='<p><a rel="nofollow" class="close-his" href="javascript:;" onclick="MAC.History.Hide();">关闭</a><a rel="nofollow" href="javascript:void(0)" onclick="MAC.History.Clear();">清空全部播放记录</a></p>';
            if(jsondata.length > 0){
				html +='<ul class="watch-list-ul">';
                ...
                html +='<ul class="watch-list-ul"><li class="no-his"><p>暂无播放历史列表...</p></li></ul>';
            }
            html += '</div>';
        ...
        'Clear': function(){
            ...
            $('.mac_history_box').html('<div class="watch-list-inner"></div><ul class="watch-list-ul"><li class="no-his"><p>已清空观看记录。</p></li></ul>');
        },
    },
