...
if ($('.tops-layout').get(0)) {
  ...
  //浏览器缩小的时候
   $(window).resize(function(){
    ...
    $("img.loading").lazyload({threshold : 300, effect : "fadeIn" });
...
jQuery(".banner-layout").slide({ titCell:".banner-smile a",effect:"fold", mainCell:".banner-slider .banner", autoPlay:true, delayTime:300, targetCell:".banner-s-tit .banner-s-t",titOnClassName:"onn"});
    ...
    tab : function()
    {
        ...
        v256.hover('#J-lianxuju-nav > a','#J-lianxuju-con > div','on');
        v256.hover('#J-lianxuju-rb-nav > a','#J-lianxuju-rb-con > div','on');
        v256.hover('#J-dianying-nav > a','#J-dianying-con > div','on');
        v256.hover('#J-dianying-rb-nav > a','#J-dianying-rb-con > div','on');
        v256.hover('#J-zongyi-nav > a','#J-zongyi-con > div','on');
		v256.hover('#J-zongyi-rb-nav > a','#J-zongyi-rb-con > div','on');
        v256.hover('#J-dongman-nav > a','#J-dongman-con > div','on');
		v256.hover('#J-dongman-rb-nav > a','#J-dongman-rb-con > div','on');
